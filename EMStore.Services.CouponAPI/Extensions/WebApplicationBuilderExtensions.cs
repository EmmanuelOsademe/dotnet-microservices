...
namespace EMStore.Services.CouponAPI.Extensions
{
	public static class WebApplicationBuilderExtensions
	{
		public static WebApplicationBuilder AddAppAuthentication(this WebApplicationBuilder builder)
		{
			...
			//var jwtSecret = builder.Configuration.GetValue<string>("ApiSettings:SecretKey");
			//var jwtIssuer = builder.Configuration.GetValue<string>("ApiSettings:Issuer");
			//var jwtAudience = builder.Configuration.GetValue<string>("ApiSettings:Audience");
